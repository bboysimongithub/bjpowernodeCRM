<%@ page import="com.tankangya.crm.settings.entity.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.tankangya.crm.workbench.entity.Tran" %>
...
<script type="text/javascript">
	...
	function changeStage (stage,i) {
		$.ajax({
			url:"workbench/transaction/saveChangeStage.do",
			data: {
				"id":"${t.id}",
				"stage":stage,
				"money":"${t.money}",
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		%>
							<span class="glyphicon glyphicon-remove mystage"
								  data-toggle="popover" onclick="changeStage('<%=listStage%>','<%=i%>')"
								  data-placement="bottom" id="<%=i%>"
