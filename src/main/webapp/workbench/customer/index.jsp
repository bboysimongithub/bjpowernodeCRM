...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveBttn").click(function () {
			$.ajax({
				...
				success:function (data) {
					...
					if (data.success) {
						alert("添加成功");
						pageCustomerList(1,$("#activityPage").bs_pagination('getOption', 'rowsPerPage'));
					}else {
						alert("添加失败")
					}
		...
		$("#getCustomerListBttn").click(function () {
		...
		$("#updateBttn").click(function () {
			$.ajax({
				...
				success:function (data) {
					if (data.success) {
						alert("修改成功");
						pageCustomerList($("#activityPage").bs_pagination('getOption', 'currentPage')
	...
	function pageCustomerList (pageNo, pageSize) {
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.datalist,function (index, element) {
					html += '<tr>';
					html += '<td><input type="checkbox" name="zx" value="'+element.id+'"/></td>';
		...
		$("#customerBody").on("click",$("input[name=zx]"),function () {
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="resetBttn" class="form-horizontal" role="form">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <button type="button" class="btn btn-default" id="getCustomerListBttn">查询</button>
